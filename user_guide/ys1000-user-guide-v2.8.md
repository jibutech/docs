...
![](https://gitee.com/jibutech/tech-docs/raw/master/images/add-cluster-2.8.0.png)
...
如果需要指定快照导出的工作节点，可以勾选“数据导入导出节点选择”，并添加亲和性规则。
...
第二步，点击“下一步”选择需要备份的集群，可选命名空间或备份模版，并选择备份资源。
