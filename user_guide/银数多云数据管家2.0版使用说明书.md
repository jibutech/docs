...
2. 进入external-snapshotter目录，切换到`release-4.0`分支
...
-   第三步，在新集群上成功安装ys1000后，使用restore-application脚本进行恢复
    
    https://github.com/jibudata/qiming-operator/blob/main/hack/restore-application.sh
    
    ```
    [root@remote-master home]# ./restore-application.sh qiming-migration ys1000-backup-1636968455
